            ...
            <div className="flex-1 text-center md:text-left space-y-4">
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center sm:items-start gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-2 mt-1 rounded-md text-xs font-semibold text-[#8BA3C7] bg-[#0d1b3e] border border-[#1a3060] hover:border-[#4DA6FF]/40 hover:text-white transition-all"
                >
