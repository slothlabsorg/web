  ...
  products: {
    ...
    items: [
      ...
      },
      {
        ...
        live: false,
        accent: '#10B981',
        comingSoonDate: 'October 12, 2026',
...
export const dataOrbitContent = {
  hero: {
    ...
    launchDate: 'Launching Monday, August 10, 2026',
  },
  features: [
...
export const bastionOrbitContent = {
  hero: {
    ...
    ctaPrimary: 'Subscribe for updates',
    ctaSecondary: 'See features ↓',
    launchDate: 'Coming Monday, October 12, 2026',
  },
  features: [
...
export const klightContent = {
  hero: {
    ...
    launchDate: 'Coming Monday, August 31, 2026',
  },
}
