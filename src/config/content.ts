...
export const slothLabsContent = {
    ...
    items: [
      {
        ...
        live: false,
        accent: '#00D4FF',
        comingSoonDate: 'September 7, 2026',
      ...
      },
      {
        ...
        live: false,
        accent: '#94A3B8',
        comingSoonDate: 'September 21, 2026',
      ...
      },
      {
        ...
        live: false,
        accent: '#10B981',
        comingSoonDate: 'September 28, 2026',
      ...
      },
      {
        ...
        logo: null,
        by: '· SlothLabs ·',
        desc: 'Your laptop is out of RAM; the machine in the other room isn\'t. Borrow its container runtime over SSH — builds and containers run there, published ports come straight back to your localhost. One command per machine.',
        tags: ['Docker', 'SSH', 'Remote builds'],
        cta: 'Learn more →',
        live: true,
        accent: '#4F8CFF',
        previewImage: null,
      ...
      },
      {
        ...
        logo: null,
        by: '· SlothLabs ·',
        desc: 'Draw a RAG or agentic flow on a canvas and get a real Python project — LangGraph and LangChain, with mock services and tests so it runs on day one. The generated code runs without the tool. Zero-dependency engine, one 80 KB file.',
        tags: ['RAG', 'Agents', 'Codegen'],
        cta: 'Learn more →',
        live: true,
        accent: '#D946EF',
        previewImage: null,
  ...
  footer: {
    ...
    products: [
      ...
      { label: 'runtime-orbit', href: '/runtime-orbit' },
    ],
...
export const dataOrbitContent = {
  hero: {
    ...
    launchDate: 'Launching Monday, September 7, 2026',
  },
  features: [
...
export const proxyOrbitContent = {
  hero: {
    ...
    ctaPrimary: 'Subscribe for updates',
    ctaSecondary: 'Learn more ↓',
    launchDate: 'Coming Monday, September 21, 2026',
  },
  features: [
...
export const bastionOrbitContent = {
  hero: {
    ...
    ctaPrimary: 'Subscribe for updates',
    ctaSecondary: 'See features ↓',
    launchDate: 'Coming Monday, September 28, 2026',
  },
  features: [
...
export const klightContent = {
  hero: {
    ...
    launchDate: 'Coming Monday, October 5, 2026',
  },
}
