  ...
  products: {
    ...
    items: [
      ...
      },
      {
        ...
        live: false,
        accent: '#10B981',
        comingSoonDate: 'October 19, 2026',
      ...
      },
      {
        ...
        slug: '/container-orbit',
        logo: null,
        by: '· SlothLabs ·',
        desc: 'Delegate Docker to a beefier machine on your LAN over SSH. Heavy builds and containers run there; published ports come straight back to your localhost, automatically. One command per side.',
        tags: ['Docker', 'SSH', 'Remote builds'],
        cta: 'Learn more →',
        live: false,
        accent: '#4F8CFF',
        comingSoonDate: 'November 9, 2026',
        previewImage: null,
        iconSrc: null,
      },
    ],
...
export const dataOrbitContent = {
  hero: {
    ...
    launchDate: 'Launching Monday, August 3, 2026',
  },
  features: [
...
export const bastionOrbitContent = {
  hero: {
    ...
    ctaPrimary: 'Subscribe for updates',
    ctaSecondary: 'See features ↓',
    launchDate: 'Coming Monday, October 19, 2026',
  },
  features: [
