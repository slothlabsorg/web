...
const BASTIONORBIT_LAUNCH = new Date('2026-09-14T12:00:00Z')
...
export const metadata: Metadata = {
  ...
  description: 'BastionOrbit is the SSH tunnel manager for macOS. One-click port forwarding through bastion hosts with auto-expiry TTL — never leave a tunnel open. Manage multiple bastions, probe connectivity, integrate with DataOrbit. Free, native Rust.',
  keywords: [
    'SSH tunnel manager',
    'SSH tunnel manager mac',
    'SSH tunnel GUI',
    'SSH port forwarding GUI',
    'bastion host UI',
    ...
    'free SSH tunnel manager',
    'BastionOrbit',
    'SlothLabs',
  ],
  openGraph: {
    title: 'SSH Tunnel Manager for macOS — BastionOrbit · One-Click Port Forwarding',
    description: 'One-click SSH tunnels through bastion hosts with auto-expiry TTL. Multi-bastion management, DataOrbit integration. Free, native Rust.',
    url: `${SITE_URL}/bastionorbit`,
    images: [{ url: '/images/bastionorbit-landing.png', width: 1200, height: 630, alt: 'BastionOrbit — SSH tunnel manager for macOS' }],
    siteName: 'SlothLabs',
  },
  alternates: { canonical: `${SITE_URL}/bastionorbit` },
  twitter: {
    card: 'summary_large_image',
    title: 'SSH Tunnel Manager for macOS — BastionOrbit',
    description: 'One-click SSH tunnels with auto-expiry TTL. Multi-bastion management. Free macOS app, native Rust.',
        ...
        <ScrollReveal>
          ...
          <p className="text-lg mt-2" style={{ color: '#4a8a6a' }}>
            {showDownload
              ...
              : 'BastionOrbit launches Monday, September 14, 2026. Subscribe to hear when it drops.'}
          </p>
        ...
        <ScrollReveal delay={80}>
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <DownloadModal
              ...
              style={{ background: ACCENT, color: BG_BASE }}
            />
            <a href={releasesUrl('bastionorbit')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-6 py-3.5 rounded-full border text-sm font-medium transition-all hover:opacity-80" style={{ borderColor: ACCENT_MID, color: ACCENT }}>
              Past releases →
            </a>
            <SubscribeModal
              accent={ACCENT}
          ...
          <p className="text-xs mt-4" style={{ color: '#5a8a6a' }}>
            <LiveVersion slug="bastionorbit" /> Free forever. macOS, Linux, Windows. Native Rust binary.
          </p>
