...
const DATAORBIT_LAUNCH = new Date('2026-09-07T12:00:00Z')
...
export const metadata: Metadata = {
  title: 'DynamoDB GUI Client for macOS — DataOrbit · Live Streaming & Cross-Joins',
  description: 'DataOrbit is the native DynamoDB GUI for macOS — DynamoDB Streams in real time, cross-table joins, full query history, and no Electron. The DynamoDB client AWS forgot to ship. Free, open source.',
  keywords: [
    'DynamoDB GUI',
    'DynamoDB client',
    'DynamoDB UI',
    'DynamoDB client mac',
    'DynamoDB Workbench alternative',
  ...
  openGraph: {
    title: 'DynamoDB GUI Client for macOS — DataOrbit · Live Streaming & Cross-Joins',
    description: 'The native DynamoDB GUI for macOS — live DynamoDB Streams, cross-table joins, query history, no Electron. Free, open source.',
    url: `${SITE_URL}/dataorbit`,
    images: [{ url: '/images/dataorbit-landing.png', width: 1200, height: 630, alt: 'DataOrbit — DynamoDB GUI client for macOS' }],
    siteName: 'SlothLabs',
  },
  alternates: { canonical: `${SITE_URL}/dataorbit` },
  twitter: {
    card: 'summary_large_image',
    title: 'DynamoDB GUI Client for macOS — DataOrbit',
    description: 'Native DynamoDB GUI with live streaming and cross-table joins. Free DynamoDB Workbench alternative.',
        ...
        <ScrollReveal>
          ...
          <p className="text-[#8BA3C7] text-lg mt-2">
            {showDownload
              ...
              : 'DataOrbit launches Monday, September 7, 2026. Subscribe to hear when it drops.'}
          </p>
