...
const CLOUDORBIT_LAUNCH = new Date('2026-09-07T12:00:00Z')
...
export const metadata: Metadata = {
  title: 'AWS Client UI for macOS — CloudOrbit · Visual AWS Session Manager',
  description:
    'CloudOrbit is the AWS client UI for macOS. Switch AWS SSO accounts, manage sessions, auto-update kubeconfig, detect EKS clusters — no terminal needed. Free Leapp alternative, native Rust, works behind Cloudflare.',
  keywords: [
    'AWS client UI',
    'AWS GUI',
    'AWS client mac',
  ...
  openGraph: {
    title: 'AWS Client UI for macOS — CloudOrbit · Visual AWS Session Manager',
    description: 'The AWS client UI for macOS — switch SSO accounts, EKS, auto-update kubeconfig. Free Leapp alternative, works behind Cloudflare. Native Rust.',
    url: `${SITE_URL}/cloudorbit`,
    siteName: 'SlothLabs',
    type: 'website',
    images: [{ url: '/images/cloudorbit-hero.png', width: 1200, height: 630, alt: 'CloudOrbit — AWS client UI for macOS' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'AWS Client UI for macOS — CloudOrbit · Visual AWS Session Manager',
    description: 'The AWS client UI for macOS. Switch SSO accounts, EKS, kubeconfig auto-update. Free Leapp alternative, native Rust.',
  },
          ...
          {CLOUDORBIT_SCREENSHOTS.map((shot, i) => (
            <ScrollReveal key={shot.src} delay={i * 60}>
              <div className="rounded-xl overflow-hidden group transition-all" style={{ boxShadow: '0 0 40px rgba(0,0,0,0.5), 0 0 0 1px rgba(26,48,96,0.3)' }}>
                <div className="overflow-hidden" style={{ maskImage: 'linear-gradient(to bottom, black 60%, transparent 100%)' }}>
                  <div
