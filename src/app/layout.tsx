  ...
  '@graph': [
    {
      ...
      name: 'SlothLabs',
      url: SITE_URL,
      description: 'SlothLabs builds dev tools for developers and DevOps. CloudOrbit, DataOrbit, WattsOrbit and more.',
      logo: { '@type': 'ImageObject', url: `${SITE_URL}/images/slothlabs-logo-light.png` },
      sameAs: ['https://github.com/slothlabsorg'],
      email: 'friends@slothlabs.org',
    },
    {
      '@type': 'WebSite',
      '@id': `${SITE_URL}/#website`,
      url: SITE_URL,
      name: 'SlothLabs',
      description: 'SlothLabs — dev tools: CloudOrbit, DataOrbit, WattsOrbit, BastionOrbit, ProxyOrbit and more.',
