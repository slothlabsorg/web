...
const WATTSORBIT_LAUNCH = new Date('2026-06-15T12:00:00Z')
...
export const metadata: Metadata = {
  title: 'Mac Power Monitor — WattsOrbit · Real-Time Watts In/Out, USB Draw & Battery Health',
  description: 'WattsOrbit is the macOS menu bar power monitor. Real-time watts in, watts out, per-device USB power draw, battery health, cycle count, temperature, and smart charge alerts. Native Rust, no Electron, free.',
  keywords: [
    'mac power monitor',
    'macOS power monitor',
    'mac watts monitor',
    'mac power monitor menu bar',
    'mac battery monitor menu bar',
    'mac USB power monitor',
    'mac input watts',
    'mac output watts',
    'mac battery health app',
    'macOS battery cycle count',
    'mac charger watts',
    'mac cable quality test',
    'apple silicon power draw',
    'macOS energy usage',
    'iStatMenus alternative free',
    'BatFi alternative',
    'WattsOrbit',
    'SlothLabs',
  ],
  openGraph: {
    title: 'Mac Power Monitor — WattsOrbit · Real-Time Watts, USB Draw & Battery Health',
    description: 'macOS menu bar power monitor: real-time watts in/out, per-device USB draw, battery health, smart alerts. Native Rust, free.',
    url: `${SITE_URL}/wattsorbit`,
    images: [{ url: '/images/wattsorbit-landing.png', width: 1200, height: 630, alt: 'WattsOrbit — Mac power monitor for the menu bar' }],
    siteName: 'SlothLabs',
  },
  alternates: { canonical: `${SITE_URL}/wattsorbit` },
  twitter: {
    card: 'summary_large_image',
    title: 'Mac Power Monitor — WattsOrbit · Watts In/Out, USB Draw, Battery Health',
    description: 'Real-time watts in/out + per-device USB power draw on macOS. Catch weak chargers, test cables, track solar. Free menu bar app.',
        ...
        <ScrollReveal delay={80}>
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <DownloadModal
              ...
              style={{ background: ACCENT, color: BG_BASE }}
            />
            <a href={releasesUrl('wattsorbit')} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-6 py-3.5 rounded-full border text-sm font-medium transition-all hover:opacity-80" style={{ borderColor: ACCENT_MID, color: ACCENT }}>
              Past releases →
            </a>
          </div>
          <p className="text-xs mt-4" style={{ color: '#4a3800' }}>
            <LiveVersion slug="wattsorbit" fallback={latestRelease?.version} /> · Free forever · macOS 10.15+ · Apple Silicon &amp; Intel
          </p>
