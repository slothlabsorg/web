...
const PROXYORBIT_LAUNCH = new Date('2026-09-28T12:00:00Z')
...
export const metadata: Metadata = {
  ...
  description: 'ProxyOrbit is a free Charles Proxy alternative for macOS. Capture HTTP/HTTPS from any Mac app, filter by method/status, inspect requests in real time. Native Rust, no Electron, no subscription.',
  keywords: [
    'Charles Proxy alternative',
    'free Charles Proxy alternative',
    'Proxyman alternative',
    'free HTTP proxy inspector',
    'free HTTPS proxy inspector mac',
    'macOS proxy inspector',
    'HTTP debugger mac',
    'API request inspector mac',
    'mitmproxy GUI',
  ...
  openGraph: {
    title: 'Free Charles Proxy Alternative for macOS — ProxyOrbit',
    description: 'Capture HTTP/HTTPS from any Mac app, filter by method/status, inspect requests in real time. Free Charles Proxy alternative built in Rust.',
    url: `${SITE_URL}/proxyorbit`,
    images: [{ url: '/images/proxyorbit-landing.png', width: 1200, height: 630, alt: 'ProxyOrbit — free Charles Proxy alternative for macOS' }],
    siteName: 'SlothLabs',
  },
  ...
  twitter: {
    ...
    title: 'Free Charles Proxy Alternative for macOS — ProxyOrbit',
    description: 'Capture HTTP/HTTPS from any Mac app, filter by method/status, inspect in real time. Native Rust, no $50 license.',
        ...
        <ScrollReveal>
          ...
          <p className="text-lg mt-2" style={{ color: '#64748B' }}>
            {showDownload
              ...
              : 'ProxyOrbit launches Monday, September 28, 2026. Subscribe to hear when it drops.'}
          </p>
