...
const RAW_ROADMAP = [
  { name: 'CloudOrbit',   launchDate: '2026-09-07', date: 'Sep 7',   desc: 'AWS session manager',             accent: '#00D4FF', icon: '☁️', slug: '/cloudorbit' },
  { name: 'WattsOrbit',   launchDate: '2026-09-07', date: 'Sep 7',   desc: 'Mac power & USB monitor',         accent: '#F59E0B', icon: '⚡', slug: '/wattsorbit' },
  { name: 'DataOrbit',    launchDate: '2026-09-07', date: 'Sep 7',   desc: 'DynamoDB & CouchDB query client', accent: '#8B5CF6', icon: '🗄️', slug: '/dataorbit' },
  { name: 'klight',       launchDate: '2026-10-05', date: 'Oct 5',   desc: 'K8s dev environments for teams',  accent: '#B4FF3C', icon: '🚀', slug: '/klight' },
