...
export const metadata: Metadata = {
  title: 'Mermaid IntelliJ Plugin — Mermaid Preview · Live Diagrams in JetBrains IDEs',
  description: 'Mermaid Preview is the IntelliJ / JetBrains IDE plugin for live Mermaid diagram rendering. IntelliJ IDEA, PyCharm, WebStorm, GoLand, Rider — open a Markdown file, see every mermaid block in a side panel. Per-block toggle, 250ms live refresh, fully offline. Free, MIT.',
  keywords: [
    'Mermaid IntelliJ plugin',
    'Mermaid JetBrains plugin',
    'Mermaid PyCharm plugin',
    'Mermaid WebStorm plugin',
    'Mermaid markdown plugin',
    'IntelliJ Mermaid preview',
    'IntelliJ Mermaid diagrams',
    'JetBrains markdown mermaid',
    'mermaid live preview IDE',
    'render mermaid in IntelliJ',
    'mermaid plugin free',
    'mermaid renderer JetBrains',
    'Mermaid Preview',
    'SlothLabs',
  ],
  openGraph: {
    title: 'Mermaid IntelliJ Plugin — Mermaid Preview · Live Diagrams in JetBrains IDEs',
    description: 'JetBrains IDE plugin for live Mermaid diagram rendering. IntelliJ, PyCharm, WebStorm and more — side-panel preview, per-block toggle, fully offline. Free.',
    url: `${SITE_URL}/mermaid-preview`,
    images: [{ url: '/images/mermaid-preview-landing.png', width: 1200, height: 630, alt: 'Mermaid Preview — IntelliJ plugin for live Mermaid diagrams' }],
    siteName: 'SlothLabs',
  },
  alternates: { canonical: `${SITE_URL}/mermaid-preview` },
  twitter: {
    card: 'summary_large_image',
    title: 'Mermaid IntelliJ Plugin — Mermaid Preview · Live JetBrains Diagrams',
    description: 'Live Mermaid diagram preview for IntelliJ, PyCharm, WebStorm and any JetBrains IDE. Per-block toggle, fully offline. Free.',
