...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/container-orbit`,          lastModified: new Date('2026-07-10'), changeFrequency: 'weekly',  priority: 0.9 },
    { url: `${BASE}/container-orbit/docs`,     lastModified: new Date('2026-07-10'), changeFrequency: 'weekly',  priority: 0.8 },
