...
6. **Agent** (`PolicyRAGAgent`) deterministic that:
   - Performs handshake
   - Lists tools
   - Calls `policy_rag` for ECONOMY_FLEX internacional
...
> **Read first:** [guia.md §8 — Layer ③ explained: FastMCP from scratch](../guia.md#8-layer--explained-fastmcp-from-scratch).
